...
* Небольшой домашний кинотеатр или саундбар для кино и игр (возможно просто колонки, если подключаемы к телевизору) или даже большую колонку, всё в одном, так сказатб, чтобы устраивать вечериночки с вами (вроде JBL PartyBox 1000 или Sony V82D)
* Смарт-часы (точно выберу сам)
...
* Флешка usb 3.* >= 64Gb
* Игрульки на xbox и/или ПК (Например, в приоритете Far Cry 5, Red Dead Redemption 2, Star Wars Jedi: Fallen Order, Sekiro: Shadows Die Twice, Cyberpunk 2077)
